...
- [x] project-to-act 台账同步：本批 P0/P1/P2/P3、成员管理、入职登记、停用进入权与重新启用已补记 `PROJECT_PROGRESS.md`（E-139～E-146）、`PROJECT_FEATURES.md`（F-091～F-098）、`PROJECT_VERSIONS.md` 与 `PROJECT_ACCEPTANCE.md`；并把“每个交付批次必须写 project-to-act”写入 AGENTS.md 长期要求。
...
- [x] 全量测试 `npm test -- --maxWorkers=2`：exit 0（131 文件 556 passed / 26 skipped）。
...
- [x] `node .ai-team/check.mjs`：Result: valid（functional 18/19，唯一未勾为 P3 后续证据附件与 P4/P5 排期项）。
